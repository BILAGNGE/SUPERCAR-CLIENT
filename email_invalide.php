...
<body>
            ...
            <div class="container"><button data-bs-toggle="collapse" class="navbar-toggler text-primary border-0" data-bs-target="#navcol-1"><span><i class="fas fa-bars fs-4"></i></span></button>
                ...
                <div class="collapse navbar-collapse" id="navcol-1">
                    <ul class="navbar-nav mx-auto">
                        ...
                        <li class="nav-item"><a class="nav-link" href="Demande d_essai.php">Demande d’Essai<br></a></li>
    ...
    <div style="text-align: center;margin-bottom: 45px;">
        <h2 class="divider-style" style="margin-top: 25px; color: red"><span>E-mail ou mot de passe invalide!</span></h2>
    </div>
