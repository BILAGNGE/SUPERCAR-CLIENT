...
<body>
    ...
    <div style="text-align:center;">
        <h2 class="divider-style" style="margin-top: -20px;"><span>Demandes d'essai</span></h2>
    </div>
...
$detail = mysqli_query($conn,$sql_voiture);
//print_r($detail);
...
while($row_voiture = mysqli_fetch_assoc($detail)){ 
    ...
    echo "<button type='button' class='btn btn-primary' onclick=\"window.location.href='Voitures.php'\">Choisir une autre voiture</button>";
    echo "</div>";
    echo "<div class='row mb-4'>";
    echo "<div class='col-md-4'>";
    echo "<img src='assets/img/VOITURE/" . $row_voiture['image1'] . "' alt='Nom de la voiture' class='img-fluid'>";
    echo "</div>";
    echo "<div class='col-md-8'>";
    echo "<h5 style='margin-left: 20px; margin-top: 10px;'>" . $row_voiture['marque'] . "&nbsp;&nbsp;" . $row_voiture['modele'] . "</h5>";
    echo "<ul style='margin-left: 20px;'>";
    echo "<li>" . $row_voiture['type'] . "</li>";
    echo "<li>" . $row_voiture['annee'] . "</li>";
    echo "<li>RS " . $row_voiture['prix'] . "</li>";
    echo "</ul>";
    echo "</div>";
    echo "</div>";
    ...
    echo "<input type='hidden' name='id_voiture' value='" . $_GET['id'] . "'>";
