...
<head>
    ...
    <link rel="stylesheet" href="assets/bootstrap/css/POLITIQUE DE CONFIDENTIALITE.css" media="screen">
...
<body>
    ...
    <div style="text-align:center;">
        <h2 class="divider-style" style="margin-top: 25px;"><span>Politiques de confidentialité</span></h2>
    </div>

    <blockquote style="margin: 40px 20px; font-size:18px; line-height:1.5; text-align:center;">
        <p style="color: #282828;">Notre entreprise tient à respecter votre vie privée et s'engage à protéger les informations personnelles que vous nous confiez.<br> Cette politique de confidentialité décrit les types d'informations que nous recueillons,<br> comment nous les utilisons et les mesures de sécurité que nous prenons pour les protéger.</p>
        <h3 style="color: rgb(255, 136, 0);">Informations recueillies</h3>
        <p p style="color: #282828;">Nous pouvons collecter les informations suivantes auprès de nos utilisateurs:</p>
        <ul style="list-style-position:inside;">
          <li p style="color: #282828;">Informations de contact, telles que le nom, l'adresse e-mail et le numéro de téléphone</li>
          <li p style="color: #282828;">Informations de facturation, telles que le nom, l'adresse et les informations de paiement</li>
          <li p style="color: #282828;">Informations relatives à la réservation de véhicules, telles que le type de véhicule,</br> la date et le lieu de départ et d'arrivée</li>
          <li p style="color: #282828;">Informations de profil, telles que l'historique de réservation et les préférences de location</li>
        </ul>
        <h3 style="color: rgb(255, 136, 0);">Utilisation des informations</h3>
        <p style="color: #282828;">Nous utilisons les informations collectées auprès de nos utilisateurs pour les fins suivantes:</p>
        <ul style="list-style-position:inside;">
          <li p style="color: #282828;">Fournir et améliorer nos services de réservation de véhicules</li>
          <li p style="color: #282828;">Traiter les réservations et les paiements</li>
          <li p style="color: #282828;">Communiquer avec nos utilisateurs pour les informer des modifications</br> apportées à nos services ou pour répondre à leurs demandes de renseignements</li>
          <li p style="color: #282828;">Personnaliser l'expérience de nos utilisateurs en fonction de leur </br>historique de réservation et de leurs préférences de location</li>
        </ul>
        <h3 style="color: rgb(255, 136, 0);">Partage des informations</h3>
        <p p style="color: #282828;">Nous ne vendons, louons ni partageons vos informations personnelles</br> à des tiers à des fins commerciales sans votre consentement explicite. </br>Nous pouvons toutefois partager vos informations dans les cas suivants:</p>
        <ul style="list-style-position:inside;">
          <li p style="color: #282828;">Avec des prestataires de services qui nous aident à gérer nos activités commerciales,</br> tels que les fournisseurs de services de paiement et les entreprises de livraison de véhicules</li>
          <li p style="color: #282828;">Si la loi l'exige ou si nous croyons de bonne foi qu'une telle action </br>est nécessaire pour protéger nos droits ou ceux de tiers</li>
        </ul>
        <h3 style="color: rgb(255, 136, 0);">Sécurité des informations</h3>
        <p p style="color: #282828;">Nous prenons des mesures de sécurité raisonnables pour protéger</br> les informations personnelles de nos utilisateurs contre la perte, l'utilisation abusive, la modification </br>ou la divulgation non autorisée. Nous utilisons des technologies de sécurité telles que les pare-feu,</br> les systèmes de cryptage pour assurer la sécurité de vos informations personnelles.</p>
      </blockquote>
