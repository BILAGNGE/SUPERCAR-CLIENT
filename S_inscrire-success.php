...
<body>
    ...
    <div style="text-align:center;">
        <h2 class="divider-style" style="margin-top: 25px;"><span>Inscription effectuée avec succès!</span></h2>
    </div>

    <br>
    
            <div id="login-box-footer" style="padding: 10px 20px;padding-bottom: 23px;padding-top: 18px;margin-bottom: -1px;">
                <p style="margin-bottom:0px;">Connectez-vous :<a id="register-link" href="Se connecter.php">Se connecter</a></p>
            </div>
        </div>
    </form>
